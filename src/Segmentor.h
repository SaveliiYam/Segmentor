...
public:
    Segmentor(const byte& pinA, const byte& pinB, const byte& pinC, const byte& pinD, const byte& pinE, const byte& pinF, const byte& pinG)
    {
        pinMode(pinA, OUTPUT);
        pinMode(pinB, OUTPUT);
        pinMode(pinC, OUTPUT);
    ...
    void discharge(const byte& first)
    {
        pinMode(first, OUTPUT);
        digitalWrite(first, LOW);
        _firstSeg = first;
    }
    void discharge(const byte& first, const byte& second)
    {
        discharge(first);
    ...
    void discharge(const byte& first, const byte& second, const byte& third)
    {
        discharge(first, second);
        pinMode(third, OUTPUT);
        digitalWrite(third, LOW);
        _thirdSeg = third;
    }
    void discharge(const byte& first, const byte& second, const byte& third, const byte& four)
    {
        discharge(first, second, third);
        pinMode(four, OUTPUT);
    ...
    void displayOne(const int& value)
    {
    ...
    void displayTwo(const int& value)
    {
        int firstNumber = value % 10;
    ...
    void displayThree(const int& value)
    {
        int firstNumber = value % 10;
        int secondNumber = value % 100 / 10;
    ...
    void displayFour(const int& value)
    {
        int firstNumber = value % 10;
        int secondNumber = value % 100 / 10;
        int thirdNumber = value / 100 % 10;
